    ...
    <Layout>
      ...
      <section className="features-section-three rel z-1 pt-110 rpt-85 pb-100 rpb-70">
        <div className="container">
          <h5 className="text-center  pb-50">Course Materials</h5>
          <div className=" ">
            {materials.length === 0 &&
              <label className="col-form-label form-label flex-Just-Center"> Looks like Course Materials list is empty</label>
            }
            {materials.length > 0 && materials.map((uris, index) => {
