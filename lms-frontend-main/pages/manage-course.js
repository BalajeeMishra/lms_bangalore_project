            ...
            {modalToggle
                && <div className="slotmodal addCourse">
                    ...
                    <Modal
                        ...
                        sm={true}
                        toggle={modalToggle}
                        onClose={() => { setModalToggle(false); setSlotDetails({ ...initialSlotDetails }); setShowDelete(false); }} >
                        <div className="row m-3">
                            <form name="slot" onSubmit={(e) => addSlotHandle(e)} autoComplete="off" className="w-100">
                                <div className="w-100">
                                    ...
                                    {showDelete && <Button className="m-2" onClick={() => deleteSlot()}> Delete </Button>}
                                </div>
                            </form>
                        </div>
                    </Modal>
            ...
            {modModalToggle
                && <div className="addCourse slotmodal">
                    ...
                    <Modal
                        ...
                        onClose={() => { setModModalToggle(false); setModuleDetails({ ...initialModDetails }); setDeleteMod(false); }} >
                        <div className="row m-3">
                            <form name="module" onSubmit={(e) => addModuleHandle(e)} autoComplete="off" className="w-100">
                                <div className="w-100">
                                    ...
                                    {deleteMod && <Button className="m-2" onClick={() => deleteModule()}> Delete </Button>}
                                </div>
                            </form>
                        </div>
                    </Modal>
                    ...
                    <Form onSubmit={(e) => createCourseDetails(e)}>
                        ...
                        <Form.Group as={Row} controlId="formPlaintextPassword">
                            ...
                            <Col sm="5">
                                ...
                                <Button onClick={() => { setDeleteMod(false); setModalToggle(true); }}>Add Slot</Button>
                                {slotsContent.map((element, index) => {
                                    return <Badge key={"manage_course_"+index} onClick={() => { onclickBadge(element, index) }} className="m-2 p-2" variant="primary">{"Slot " + (index + 1)}</Badge>
                                })}
                            </Col>
                        </Form.Group>
                        ...
                        <Form.Group as={Row} controlId="formPlaintextmoddetails">
                            ...
                            <Col sm="5">
                                {/* start date  frequesncy timing soldout weekend */}
                                <Button onClick={() => { setModModalToggle(true); }}>Add Module</Button>
                                {moduleContent.map((element, index) => {
                                    return <Badge key={"manage_course_add"+index}  onClick={() => { onclickBadgeMod(element, index) }} className="m-2 p-2" variant="primary">{"Module " + (index + 1)}</Badge>
                                })}
                            </Col>
                        </Form.Group>
