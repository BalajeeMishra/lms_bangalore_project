...
const CreateMeet = () => {
            ...
            <div className="form-group row">
                    ...
                    <div className="col-sm-8 col-md-8">
                        <select 
                            name="meet_course" 
                            onChange={handleChange}
                            value={input.meet_course}
                            className="form-select">
                            <option value="">Select Module</option>    
                            {courseList && courseList.map((e, key) => {
  ...
  function MeetList(){
    ...
    return(
        ...
        {meetList === "" &&
            <label className="col-form-label form-label"> Looks like Meeting Link is empty, start creating Meeting</label>
        }
        {meetList && 
