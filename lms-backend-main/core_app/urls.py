...
urlpatterns = [
    ...
    path('add_quiz_question/<int:quiz_question_id>',AddQuizQuestions.as_view(), name='update_quiz_question'),
    path('course_category',AddCourseCategory.as_view(), name='add_quiz_course_category'),
    path('add_course',AddCourse.as_view(), name='add_course'),
    path('add_course/<int:course_id>',AddCourse.as_view(), name='update_course'), #Edit course
    path('add_course_quiz',AddCourseQuiz.as_view(), name='add_course'),
    path('add_assignment',AddAssignment.as_view(), name='add_assignment'),
    path('add_assignment/<int:assignment_id>',AddAssignment.as_view(), name='update_assignment'),
    ...
    path("upload_course_material/<str:course_id>", CourseMatrialFileUpload.as_view(), name="course_get_by_id"),
    path("get_course_material/<str:course_id>", CourseMatrialFileUpload.as_view(), name="course_get_by_id"),
    path("student_assignment_material_list",StudentAssignmentMaterialList.as_view(), name="assignment_material_list"),
    path("student_course_material_list",StudentCourseMaterialList.as_view(), name="assignment_course_list"),

    path("upload_assignment_material/<str:assignment_id>", AssignmentMatrialFileUpload.as_view(), name="assignment_get_by_id"),
    path("get_assignment_material/<str:course_id>", AssignmentMatrialFileUpload.as_view(), name="course_get_by_id"),

    path("upload_student_assignment_material/<str:assignment_id>", StudentAssignmentMatrialFileUpload.as_view(), name="assignment_get_by_id"),
    path("uploaded_student_assignment_material_list/", StudentUploadedAssignmentList.as_view(), name="uploaded_assigment_material_list"),
    
    path("zoom", ZoomMeeting.as_view(), name="zoom_meeting_get_by_id"),
    path("zoom/<str:course_id>", ZoomMeeting.as_view(), name="zoom_meeting_get_by_id"),
    path("zoom/<str:course_id>/<str:meeting_id>", ZoomMeeting.as_view(), name="zoom_meeting_get_by_id"),

    path('store_recording123/', store_recording, name="store_recording"),
